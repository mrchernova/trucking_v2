...
INSERT INTO USERS (LOGIN, PASSWORD, EMAIL, ROLE, STATUS, LE_ID) VALUES ('1', '1','administrator@gmail.com', 0,'ACTIVE', null);
INSERT INTO USERS (LOGIN, PASSWORD, EMAIL, ROLE, STATUS, LE_ID) VALUES ('nikolaevna', 'user','u.user1@gmail.com', 1, 'ACTIVE', 1);
INSERT INTO USERS (LOGIN, PASSWORD, EMAIL, ROLE, STATUS, LE_ID) VALUES ('parket', 'user','u.user2@gmail.com', 1, 'ACTIVE', 2);
INSERT INTO USERS (LOGIN, PASSWORD, EMAIL, ROLE, STATUS, LE_ID) VALUES ('delivery_driver', 'user','u.user3@gmail.com', 2, 'ACTIVE', 3);
INSERT INTO USERS (LOGIN, PASSWORD, EMAIL, ROLE, STATUS, LE_ID) VALUES ('shop_avto', 'user','u.user4@gmail.com', 2, 'ACTIVE', 4);
INSERT INTO USERS (LOGIN, PASSWORD, EMAIL, ROLE, STATUS, LE_ID) VALUES ('logistic_drive', 'user','u.user5@gmail.com', 2, 'ACTIVE', 5);
